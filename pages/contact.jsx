        ...
        <BannerLayout>
            <div className=" px-4 py-2">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>Japan</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>City:</span>
                                <span className='text-LightGray md:text-sm'>Osaka</span>
                            </div>
                            <div className="flex justify-between items-center">
                        ...
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray text-sm'>zeusa1398@gmail.com</span>
                            </div>
                          
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Discord:</span>
                                <span className='text-LightGray text-sm'>qw04750</span>
                            </div>
                            
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Phone:</span>
                                <span className='text-LightGray text-sm'>+080 557 44194</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/Zeus-Aphrodite?tab=repositories&q=&type=&language=&sort=" target='_blank' rel="noreferrer"><FaGithub /></a>
            ...
            >
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <a className='underline text-Snow' target='_blank' href='https://github.com/Zeus-Aphrodite' > Be the one to integrate this!</a>
                </div>
            </Modal>
            <Footer />
        </BannerLayout>
